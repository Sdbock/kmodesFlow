...
The goal of kmodesFlow is to improve workflow efficiency when using kmodes models.
...
The *kmodesFlow* package provides convience functions to accompany the *klaR::kmodes()* function, improving overall workflow with kmodes modeling. To demo the functionality of the package, I will use a dataset on Telco customer churn (see more on the data here: https://www.kaggle.com/datasets/blastchar/telco-customer-churn).
